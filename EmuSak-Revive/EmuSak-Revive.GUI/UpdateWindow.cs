...
namespace EmuSak_Revive.GUI
{
    public partial class UpdateWindow : Form
    {
        ...
        private void UpdateWindow_Load(object sender, EventArgs e)
        {
            ...
            Changelog_Textbox.Text = VersionControl.Changelog;
            Changelog_Textbox.Visible = false;
            webBrowser1.DocumentText = VersionControl.Changelog;
        }
        ...
        private async void StartUpdateProcess()
        {
            ...
            {
                GitHubToken = "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"; //<-- Your github api token here
            }
